...
```
![image](https://user-images.githubusercontent.com/115037574/236257390-29c1b53c-900c-4b24-96ea-4d1790dbd678.png)
...
```
![image](https://user-images.githubusercontent.com/115037574/236257498-da8fddaa-0981-4780-97b9-cd8fc9fb04a6.png)
...
```
![image](https://user-images.githubusercontent.com/115037574/236257660-7bd2a04a-668f-42c4-9662-960df565d9b3.png)
...
```
![image](https://user-images.githubusercontent.com/115037574/236257797-7d43d43c-10fb-411a-aeac-0bd518f4943f.png)
...
namespace ConversionExample
{
    class Complex
    {
        ...
        public static bool operator <(Complex one, Complex two)
        {
            // ตรวจสอบจาก magnitude ของ complex number
